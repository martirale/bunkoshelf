...
const dictionaries: Record<Locale, () => Promise<Record<string, DictionarySection>[]>> = {
  en: () =>
    Promise.all([
      ...
      import("./dictionaries/en/books.json").then((m) => m.default),
      import("./dictionaries/en/manga.json").then((m) => m.default),
      import("./dictionaries/en/reader.json").then((m) => m.default),
      import("./dictionaries/en/epubReader.json").then((m) => m.default),
      ...
      import("./dictionaries/en/catalog.json").then((m) => m.default),
  ...
  es: () =>
    Promise.all([
      ...
      import("./dictionaries/es/books.json").then((m) => m.default),
      import("./dictionaries/es/manga.json").then((m) => m.default),
      import("./dictionaries/es/reader.json").then((m) => m.default),
      import("./dictionaries/es/epubReader.json").then((m) => m.default),
      ...
      import("./dictionaries/es/catalog.json").then((m) => m.default),
