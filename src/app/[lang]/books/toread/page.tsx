...
async function BooksToReadPageContent({
  params,
  searchParams,
}: {
  ...
  return <WantToRead lang={lang as Locale} intl={intl} authorFilter={author} genreFilter={genre} tagFilter={tag} />;
}

export default function BooksToReadPage(props: {
  params: Promise<{ lang: string }>;
  searchParams: Promise<Record<string, string | undefined>>;
}) {
